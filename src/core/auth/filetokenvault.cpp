...
bool
FileTokenVault::storeRefreshToken(const QString &accountEmail, const QString &refreshToken) {
    QJsonObject obj;
...
QString
FileTokenVault::loadRefreshToken(const QString &accountEmail) {
    QFile in(m_path);
...
bool
FileTokenVault::removeRefreshToken(const QString &accountEmail) {
    QFile in(m_path);
